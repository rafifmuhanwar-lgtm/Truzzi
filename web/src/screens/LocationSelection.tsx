  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col">
      <div className="flex-1 relative overflow-y-auto flex flex-col px-6 pt-10 pb-10 scrollbar-hide">
        ...
        >
          <path
            d="M0,140 L0,90 C60,70 90,110 140,85 C190,60 220,40 270,75 C320,110 350,80 400,55 L400,140 Z"
            fill="white"
          />
          <path
            d="M0,110 L0,140 L400,140 L400,90 C350,115 320,140 270,95 C220,50 190,80 140,105 C90,130 60,90 0,110 Z"
            fill="white"
            opacity="0.6"
          />
        </svg>
