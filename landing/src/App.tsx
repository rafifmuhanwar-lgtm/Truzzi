    ...
    <div className="min-h-screen font-sans bg-slate-50 text-slate-900 selection:bg-primary/20 relative">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between relative">
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="https://truzzi-app.vercel.app" className="text-[14px] font-medium text-slate-600 hover:text-primary transition-colors">Log In</a>
            <a href="https://truzzi-app.vercel.app" className="bg-slate-900 text-white px-5 py-2.5 rounded text-[14px] font-medium hover:bg-slate-800 transition-colors">
              Titip Sekarang
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-xl px-6 py-6 flex flex-col text-slate-700">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://truzzi-app.vercel.app" className="w-full text-center py-3.5 font-bold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors">Log In</a>
              <a href="https://truzzi-app.vercel.app" className="w-full text-center py-3.5 font-bold text-white bg-primary rounded-xl hover:bg-primary-hover shadow-sm">Titip Sekarang</a>
            </div>
          </div>
        )}
      </header>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <a href="https://truzzi-app.vercel.app" className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded text-base font-medium hover:bg-primary-hover transition-colors text-center">
      ...
      <section id="jastiper" className="py-24">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <a href="https://truzzi-mitra.vercel.app" className="inline-block border-2 border-slate-900 text-slate-900 px-8 py-3 rounded font-medium hover:bg-slate-50 transition-colors">
      ...
      <section className="bg-primary/95 backdrop-blur-md py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a href="https://truzzi-app.vercel.app" className="inline-block bg-white text-primary px-10 py-4 rounded font-bold hover:bg-slate-100 transition-colors">
            Mulai Titip Sekarang
          </a>
        </div>
      </section>
