...
function PhoneFrame({
  ...
  return (
    <div className="w-[280px] shrink-0 snap-center flex flex-col items-center gap-4 group">
      <div
        className={`px-4 py-1.5 rounded-full text-[10px] font-bold tracking-wider ${role === 'customer' ? 'bg-slate-100 text-slate-600' : 'bg-primary/10 text-primary'}`}
      >
      ...
      <div className="w-[260px] aspect-[1/2.15] rounded-[2.5rem] border-[10px] border-slate-900 shadow-xl overflow-hidden bg-slate-50 relative group-hover:-translate-y-2 transition-transform duration-500">
        ...
        <div className="pt-7 flex flex-col h-full relative z-10">
          ...
          <div className="h-14 bg-white border-t border-slate-100 flex justify-around items-center px-4 shrink-0 relative z-20">
            <div
              className={`flex flex-col items-center gap-1 ${activeTab === 0 ? 'text-primary' : 'text-slate-300'}`}
            >
              <Home size={18} strokeWidth={activeTab === 0 ? 2.5 : 2} />
            </div>
            <div
              className={`flex flex-col items-center gap-1 ${activeTab === 1 ? 'text-primary' : 'text-slate-300'}`}
            >
              <FileText size={18} strokeWidth={activeTab === 1 ? 2.5 : 2} />
            </div>
            <div
              className={`flex flex-col items-center gap-1 ${activeTab === 2 ? 'text-primary' : 'text-slate-300'}`}
            >
  ...
  return (
    <div className="min-h-screen font-sans bg-slate-50 text-slate-900 selection:bg-primary/20 relative">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-slate-100">
          <div className="max-w-6xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between relative">
            ...
            <nav className="hidden md:flex items-center gap-8 text-[14px] font-medium text-slate-600">
              ...
              <a href="#jastiper" className="hover:text-primary transition-colors">
                Jadi Jastiper
              </a>
            </nav>
            ...
            <div className="hidden md:flex items-center gap-6">
              <a
                href="https://truzzi-app.vercel.app"
                className="text-[14px] font-medium text-slate-600 hover:text-primary transition-colors"
              >
                Log In
              </a>
              <a
                href="https://truzzi-app.vercel.app"
                className="bg-slate-900 text-white px-5 py-2.5 rounded text-[14px] font-medium hover:bg-slate-800 transition-colors"
              >
                Titip Sekarang
              </a>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-xl px-6 py-6 flex flex-col text-slate-700">
              ...
              <div className="flex flex-col gap-3">
                <a
                  href="https://truzzi-app.vercel.app"
                  className="w-full text-center py-3.5 font-bold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors"
                >
                  Log In
                </a>
                <a
                  href="https://truzzi-app.vercel.app"
                  className="w-full text-center py-3.5 font-bold text-white bg-primary rounded-xl hover:bg-primary-hover shadow-sm"
                >
                  Titip Sekarang
                </a>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0">
              ...
              <p className="text-base md:text-lg text-slate-600 leading-relaxed mb-8 md:mb-10">
                Mau titip makanan, belanja barang, atau cari sesuatu yang jauh dari kamu? Temukan
                Jastiper terpercaya dan selesaikan semuanya tanpa ribet.
              </p>

              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                <a
                  href="https://truzzi-app.vercel.app"
                  className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded text-base font-medium hover:bg-primary-hover transition-colors text-center"
                >
                  Mulai Titip Sekarang
                </a>
                <a
                  href="#how-it-works"
                  className="w-full sm:w-auto text-slate-900 border border-slate-300 px-8 py-4 rounded text-base font-medium hover:bg-slate-50 transition-colors text-center"
                >
                  Lihat Cara Kerja
                </a>
              </div>
                ...
                <div className="pt-8 flex flex-col h-full relative z-10 bg-slate-50">
                  ...
                  <div className="bg-primary rounded-b-[28px] px-5 pt-5 pb-6 shrink-0 relative">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="w-12 h-12 bg-white/20 rounded-xl overflow-hidden shadow-inner flex items-center justify-center text-white/50">
                        <img
                          src="https://api.dicebear.com/7.x/avataaars/svg?seed=Budi&backgroundColor=e2e8f0"
                          alt="avatar"
                  ...
                  <div className="flex-1 p-4 space-y-5 overflow-hidden">
                    ...
                    <div className="bg-gradient-to-br from-primary via-primary to-[#5C1A3A] rounded-2xl p-4 relative overflow-hidden shadow-md mx-1">
                      ...
                      <p className="text-white/80 text-[9px] mt-1">
                        Khusus hari ini, tanpa minimal transaksi!
                      </p>
                    </div>
                  </div>
        ...
        <section
          id="how-it-works"
          className="py-24 bg-white/40 backdrop-blur-md border-b border-slate-200/50"
        >
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-4 gap-12 md:gap-8">
                <div className="relative pt-8 md:pt-10">
                  <div className="absolute top-0 left-0 text-sm font-bold text-slate-900 bg-slate-50 pr-4 z-10">
                    01
                  </div>
                ...
                <div className="relative pt-8 md:pt-10">
                  <div className="absolute top-0 left-0 text-sm font-bold text-slate-400 bg-slate-50 pr-4 z-10">
                    02
                  </div>
        ...
        <section
          id="showcase"
          className="py-24 border-b border-slate-200/50 overflow-hidden bg-slate-100/30 backdrop-blur-sm"
        >
          <div className="max-w-6xl mx-auto px-6 mb-16 text-center">
            <h2 className="text-3xl font-bold mb-4">Kenali Aplikasinya</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Geser layar untuk melihat alur kerja antara Customer yang menitip pesanan dan Jastiper
              yang menyelesaikan tugasnya secara real-time.
            </p>
          </div>
            ...
            <div className="flex gap-8 px-[10vw] md:px-[20vw] lg:px-[calc(50vw-440px)] min-w-max">
                ...
                <div className="h-full bg-slate-50 flex flex-col">
                  <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                    <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm">
                      <div className="text-[9px] font-bold text-slate-400 mb-1.5 flex items-center gap-1">
                        <MapPin size={10} /> Lokasi Pembelian (Opsional)
                      </div>
                      <div className="text-[11px] font-semibold text-slate-900 pb-1 border-b border-slate-100">
                    ...
                    <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm space-y-3">
                      <div>
                        ...
                        <div className="p-2.5 bg-slate-50 rounded-xl text-[10px] text-slate-700 border border-slate-100">
                          Beli Kopi Tuku 2, Donat Kampung 3. Tolong pilih yang donatnya empuk ya.
                          Kopi es dipisah.
                        </div>
                      </div>
                      <div className="flex gap-2">
                        <div className="flex-1">
                          ...
                          <div className="h-8 bg-slate-50 rounded-lg border border-slate-100 flex items-center px-2 text-[10px] font-bold">
                            Rp 50.000
                          </div>
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="h-8 bg-slate-50 rounded-lg border border-slate-100 flex items-center px-2 text-[10px] font-bold text-emerald-600">
                            Rp 20.000
                          </div>
                        </div>
                      </div>
              ...
              <PhoneFrame title="Daftar Pesanan" role="jastiper" activeTab={1}>
                <div className="h-full bg-slate-50 flex flex-col">
                  <div className="px-4 pt-3">
                    {/* Tabs */}
                    <div className="flex gap-2">
                      <div className="flex-1 h-8 rounded-full bg-primary text-white text-[10px] font-bold flex items-center justify-center">
                        Aktif (1)
                      </div>
                      <div className="flex-1 h-8 rounded-full bg-white border border-slate-200 text-slate-500 text-[10px] font-bold flex items-center justify-center">
                        Riwayat (12)
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2 mt-3">
                      <div className="flex-1 h-8 bg-white border border-slate-200 rounded-lg flex items-center px-2 text-[9px] text-slate-500">
                        Jenis: Semua <ChevronDown size={10} className="ml-auto" />
                      </div>
                      <div className="flex-1 h-8 bg-white border border-slate-200 rounded-lg flex items-center px-2 text-[9px] text-slate-500">
                        Urut: Terbaru <ChevronDown size={10} className="ml-auto" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-4 overflow-y-auto">
                    ...
                    <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        <span className="px-2 py-0.5 rounded-full text-[9px] font-bold text-white bg-emerald-500">
                          JASTIP
                        </span>
                        <span className="text-[9px] text-slate-400">Baru saja</span>
                      </div>
                      <p className="font-bold text-xs text-slate-900 leading-tight">
                        Beli Kopi Tuku 2, Donat Kampung 3
                      </p>
                      <p className="text-[10px] text-slate-500 mt-1 line-clamp-2">
                        Tolong pilih yang donatnya empuk ya. Kopi es dipisah.
                      </p>
                      <p className="text-[10px] mt-2">
                        <span className="font-semibold text-slate-900">Ongkir:</span>{' '}
                        <span className="text-slate-700">Rp 20.000</span>
                        <span className="text-slate-400"> (Belanja: Rp 50.000)</span>
                      </p>
                      <div className="mt-2 space-y-1">
                        <p className="flex gap-1.5 text-[9px] text-slate-500">
                          <Navigation size={12} className="text-emerald-500" /> Antar ke: Jl.
                          Sudirman No 1
                        </p>
                      </div>
                      <button className="w-full h-8 mt-3 rounded-xl border border-primary text-primary text-[10px] font-bold">
                        Lihat Detail
                      </button>
                    </div>
                  </div>
              ...
              <PhoneFrame title="Detail Pesanan" role="jastiper" activeTab={1}>
                <div className="h-full bg-slate-50 flex flex-col">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1 text-[9px] text-slate-500 mt-0.5">
                            <Star size={10} className="text-amber-400 fill-amber-400" /> 5.0 (20
                            Pesanan)
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="p-4 bg-white border-t border-slate-100 shrink-0">
                    <button className="w-full h-10 bg-primary text-white text-[11px] font-bold rounded-xl shadow-sm">
                      Terima Pesanan
                    </button>
                  </div>
                </div>
                  ...
                  <div className="flex-1 p-4 overflow-y-auto">
                    <div className="bg-primary/5 border border-primary/10 rounded-2xl p-3 mb-4">
                      ...
                      <div className="mt-2 space-y-1.5 text-[11px]">
                        <div className="flex justify-between">
                          <span className="text-slate-500">Jastiper</span>
                          <span className="font-semibold text-slate-900">Budi Setiawan</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-500">Estimasi Belanja</span>
                          <span className="font-semibold text-slate-900">Rp 50.000</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-500">Tarif Jastip</span>
                          <span className="font-semibold text-slate-900">Rp 20.000</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1 p-3 overflow-y-auto space-y-2 bg-slate-50 flex flex-col justify-end">
                    ...
                    <div className="flex justify-end">
                      <div className="max-w-[85%] px-3 py-2 text-[10px] bg-primary text-white rounded-[12px_12px_2px_12px]">
                        ...
                        <div className="text-[8px] text-white/70 text-right mt-1 flex justify-end gap-1 items-center">
                          12:46 <CheckCircle2 size={10} />
                        </div>
                      </div>
                    </div>
                    <div className="flex justify-start">
                ...
                <div className="p-4 h-full bg-slate-50 flex flex-col justify-center text-center">
                  <div className="mb-6">
                    ...
                    <p className="text-[10px] text-slate-500 mt-1 px-4 leading-relaxed">
                      Terima kasih telah menggunakan Truzzi. Dana jastip telah diteruskan ke
                      Jastiper.
                    </p>
                  </div>

                  <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm text-center mb-6">
                    <div className="text-[10px] font-bold text-slate-900 mb-3">
                      Berikan Penilaian
                    </div>
        ...
        <section id="jastiper" className="py-24">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-10">
              Jadilah Jastiper Truzzi. Ambil pesanan yang searah dengan tujuanmu, sepakati harga
              secara transparan, dan dapatkan penghasilan tambahan tanpa tekanan.
            </p>
            <a
              href="https://truzzi-mitra.vercel.app"
              className="inline-block border-2 border-slate-900 text-slate-900 px-8 py-3 rounded font-medium hover:bg-slate-50 transition-colors"
            >
        ...
        <section className="bg-primary/95 backdrop-blur-md py-24">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <a
              href="https://truzzi-app.vercel.app"
              className="inline-block bg-white text-primary px-10 py-4 rounded font-bold hover:bg-slate-100 transition-colors"
            >
              Mulai Titip Sekarang
            </a>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              <img
                src="/logo.png"
                alt="Truzzi Logo"
                className="h-6 w-auto grayscale brightness-0 invert opacity-50"
              />
