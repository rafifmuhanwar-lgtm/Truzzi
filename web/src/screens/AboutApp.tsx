    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 max-w-lg w-full mx-auto px-6 py-8 text-center">
        ...
        <p className="text-sm text-ink-secondary leading-relaxed mt-6 max-w-sm mx-auto">
          Truzzi adalah platform marketplace Open Jastip terpercaya Indonesia. Titip belanja barang
          & kuliner favorit melalui jastiper terverifikasi. Transaksi aman dengan sistem TruzziPay
          Rekber (Escrow).
        </p>
