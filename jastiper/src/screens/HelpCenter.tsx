    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-5 py-5 space-y-6 max-w-lg mx-auto pb-8">
          ...
          {FAQS.map((f, i) => (
            <div key={i} className="card overflow-hidden">
              ...
              >
                ...
                <ChevronDown size={18} className={`shrink-0 text-ink-secondary transition-transform ${openIdx === i ? 'rotate-180' : ''}`} />
              </button>
              {openIdx === i && (
        ...
        <div className="grid grid-cols-2 gap-3">
          <button onClick={() => navigate('/cs-chat')} className="card-pad flex flex-col items-center gap-2 hover:border-primary/40">
          ...
          <a href="mailto:support@truzzi.id" className="card-pad flex flex-col items-center gap-2 hover:border-primary/40">
